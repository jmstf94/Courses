...
s,k=pegasos(train_bow_features, train_labels, 25, 0.01)
l,p=pegasos(test_bow_features, test_labels, 25, 0.01)
f=classify(test_bow_features,s,k)
m=classify(test_bow_features,l,p)
print(accuracy(f,m))
